...
Začnemo preurejati LHS, in sicer najprej potrebujem člen $norm(x+z)^2$. Preuredim prvi člen od LHS:

$
  norm(x+y+z)^2 = norm((x+z)+y)^2 \
$

Uporabim paralelogramsko identiteto:
...
Dobim naslednji člen $norm(x-z)^2$ iz drugega člena LHS. Najprej preuredim:
...
Zadnjič uporabim paralelogramsko identiteto:
